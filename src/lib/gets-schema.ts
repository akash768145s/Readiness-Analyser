...
export const GETS_SCHEMA: GETSField[] = [
    { path: "invoice.id", type: "string", required: true },
    { path: "invoice.issue_date", type: "date", format: "YYYY-MM-DD", required: true },
    { path: "invoice.currency", type: "enum", enum: ["AED", "SAR", "MYR", "USD"], required: true },
    ...
    { path: "seller.country", type: "string", pattern: "^[A-Z]{2}$", required: true },
    ...
    { path: "buyer.country", type: "string", pattern: "^[A-Z]{2}$", required: true },
